...
/*Для объекта obj и свойства х вызов obj.hasOwnProperty(х) возвратит true, если у obj будет свойство х, и false, если
свойство х не определено или определено в цепи прототипов.*/
...
// метода hasOwnProperty) Object.keys включает только свойства, определенные в прототипе.
